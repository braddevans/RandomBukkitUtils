...
public class NBTTagList extends NBTBase {
    ...
    public double d(int i) {
        if (i >= 0 && i < this.list.size()) {
            ...
            return nbtbase.getTypeId() == 6 ? ((NBTTagDouble) nbtbase).getTagDouble() : 0.0D;
        } else {
            return 0.0D;
        }
    }
    ...
    public float e(int i) {
        if (i >= 0 && i < this.list.size()) {
            ...
            return nbtbase.getTypeId() == 5 ? ((NBTTagFloat) nbtbase).getTagFloat() : 0.0F;
        } else {
            return 0.0F;
        }
    }
    ...
    public String getString(int i) {
        if (i >= 0 && i < this.list.size()) {
            ...
            return nbtbase.getTypeId() == 8 ? nbtbase.getData() : nbtbase.toString();
        } else {
            return "";
        }
    }
